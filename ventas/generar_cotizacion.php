...
// Nuevos campos para aumento y reducción numéricos
...
// Total neto aplicando el aumento y la reducción
$totalNeto = $subtotal + $aumento - $reduccion;
        ...
        <form method="POST" action="generar_pdf.php" target="_blank">
            ...
            <div class="bg-white rounded-[2rem] shadow-xl p-6 mb-6 no-print">
                ...
                <div class="border-t border-slate-100 pt-4 grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        <label class="text-xs font-black uppercase text-rose-600">Reducción / Descuento (Resta al total
                            RD$)</label>
                        <input type="number" step="0.01" min="0" name="reduccion" value="<?= $reduccion ?>"
            ...
            <div class="p-10 bg-slate-50 border-t border-slate-100 flex flex-col items-end">
                <div class="w-full md:w-80 space-y-2 text-right text-slate-600">
                    ...
                    <div class="flex justify-between text-rose-600">
                        <span>Reducción (-):</span>
                        <span class="font-bold">RD$ <?= number_format($reduccion, 2) ?></span>
                    </div>
                    <?php endif; ?>
