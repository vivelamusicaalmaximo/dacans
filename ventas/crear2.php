...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['procesar_venta'])) {
    try {
        ...
        // CORREGIDO: Evaluamos correctamente si el método seleccionado es Crédito (ID 4)
        ...
        if ($esCredito) {
            ...
            if ($monto_pagado < $total_neto_factura) {
                throw new Exception("El pago es insuficiente para completar la venta.");
            }
        }
        ...
        // CORREGIDO: Ahora entrará de forma efectiva aquí cuando $id_metodo_pago sea 4
        if ($esCredito) {
            $stmtCxC = $pdo->prepare("
      ...
      $sqlInsertDetalle = "INSERT INTO factura_detalle (id_factura, id_producto, cantidad, precio_unitario, itbis_aplicado, descuento_aplicado, subtotal_linea) VALUES (?, ?, ?, ?, ?, 0.00, ?)";
        ...
        // CORREGIDO: Ahora cambia a 'CREDITO' en lugar de 'Reservada'
        ...
        foreach ($detalles_a_insertar as $det) {
            ...
            // Se ejecutará con 'CREDITO' o 'Vendida' según corresponda
      ...
      /* =========================================================
        ...
        if ($infoCliente && !empty($infoCliente['email'])) {
            ...
            // CORREGIDO: Inicialización directa gracias al "use" del inicio del archivo
            ...
            try {
                ...
                // CORREGIDO: Simplificado para evitar que PHP duplique el Namespace
